...
VAR varStruct[] = { {&testVar, eVARTYPE_RAM, eDTYPE_F32,NULL},           // Number 1
                    {&f_test, eVARTYPE_EEPROM, eDTYPE_F32,NULL},         // Number 2
                    {&ui8_test, eVARTYPE_EEPROM, eDTYPE_UINT8,NULL},     // Number 3
                    {&ui16_test, eVARTYPE_EEPROM, eDTYPE_UINT16,NULL},   // Number 4
                    {&i32_test, eVARTYPE_EEPROM, eDTYPE_INT32,NULL}};    // Number 5
