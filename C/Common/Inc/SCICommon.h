...
typedef enum
{
    eSCI_MASTER_ERROR_NONE = 0,
    eSCI_MASTER_ERROR_VAR_NUMBER_INVALID,
    eSCI_MASTER_ERROR_UNKNOWN_DATATYPE,
    eSCI_MASTER_ERROR_REQUEST_IDENTIFIER_NOT_FOUND,
    eSCI_MASTER_ERROR_NUMBER_CONVERSION_FAILED,
    eSCI_MASTER_ERROR_ACKNOWLEDGE_UNKNOWN,
...
typedef enum
{
    eSCI_SLAVE_ERROR_NONE = 0,
    eSCI_SLAVE_ERROR_EEPROM_PARTITION_TABLE_NOT_SUFFICIENT,
    eSCI_SLAVE_ERROR_VAR_NUMBER_INVALID,
    eSCI_SLAVE_ERROR_UNKNOWN_DATATYPE,
    eSCI_SLAVE_ERROR_EEPROM_ADDRESS_UNKNOWN,
    eSCI_SLAVE_ERROR_EEPROM_READOUT_FAILED,
    eSCI_SLAVE_ERROR_EEPROM_WRITE_FAILED,
    eSCI_SLAVE_ERROR_REQUEST_IDENTIFIER_NOT_FOUND,
